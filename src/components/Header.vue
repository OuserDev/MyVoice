    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <router-link to="/" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
          <img src="/logow.png" lass="bi me-2" width="88" height="80" role="img" aria-label="Bootstrap">
        </router-link>
...
@import "https://getbootstrap.com/docs/5.3/examples/headers/";
...
.fixed-top {
  ...
  left: 0;
  right: 0;
  z-index: 1030; /* 다른 요소들 위에 위치하도록 z-index 설정 */
}

.content {
  margin-top: 200px; /* header의 높이에 맞게 조정 */
}
</style>
